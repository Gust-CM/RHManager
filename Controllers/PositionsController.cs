...
namespace RHManager.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PositionId,Name,DepartmentId")] Position position)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "DepartmentId", "Name", position.DepartmentId);
            return View(position);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PositionId,Name,DepartmentId")] Position position)
        {
